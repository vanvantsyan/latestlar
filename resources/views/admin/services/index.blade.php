    ...
    <div class="m-subheader ">
        <div class="d-flex align-items-center">
            <div class="mr-auto">
                ...
                {!! Breadcrumbs::generate(['Рабочий стол', 'Дополнительные услуги'], 'metronic') !!}
            </div>
        </div>
    </div>
...
@section('js')
    ...
    <script type="text/javascript">
        var DatatableMenu = function() {
            var e = function() {
                var e = JSON.parse('<?php echo $services; ?>')
                    ...
                    columns: [{
                        ...
                        template: function(e) {
                            return '<div class="dropdown ' + (e.getDatatable().getPageSize() - e.getIndex() <= 4 ? "dropup" : "") + '">' +
                                ...
                                '<a class="dropdown-item" href="/admin/services/'+e.id+'/edit"><i class="la la-edit"></i> Редактировать</a>' +
                                '<a class="dropdown-item" href="/admin/services/delete?id='+e.id+'"><i class="la la-print"></i> Удалить' +
                                '</a></div></div>' +
