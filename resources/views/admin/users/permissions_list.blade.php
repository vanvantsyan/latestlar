    ...
    <div class="m-subheader ">
        <div class="d-flex align-items-center">
            <div class="mr-auto">
                ...
                {!! Breadcrumbs::generate(['Рабочий стол', 'Права'], 'metronic') !!}
            </div>
        </div>
    </div>
                ...
                <div class="m-form m-form--label-align-right m--margin-top-20 m--margin-bottom-30">
                    <div class="row align-items-center">
                        ...
                        <div class="col-xl-4 order-1 order-xl-2 m--align-right">
                            <a href="{{ url('admin/permissions/create') }}" class="btn btn-accent m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
                                <span>
...
@section('js')
    ...
    <script type="text/javascript">
        var DatatableMenu = function() {
            var e = function() {
                var e = JSON.parse('<?php echo $permissions; ?>')
                    ...
                    columns: [{
                        ...
                        template: function(e) {
                            return '<div class="dropdown ' + (e.getDatatable().getPageSize() - e.getIndex() <= 4 ? "dropup" : "") + '">' +
                                ...
                                '<a class="dropdown-item" href="/admin/permissions/'+e.id+'/edit"><i class="la la-edit"></i> Редактировать</a>' +
                                '<a class="dropdown-item" href="/admin/permissions/delete?id='+e.id+'"><i class="la la-trash"></i> Удалить' +
                                '</a></div></div>' +
