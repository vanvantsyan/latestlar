    ...
    <div class="m-subheader ">
        <div class="d-flex align-items-center">
            <div class="mr-auto">
                ...
                {!! Breadcrumbs::generate(['Рабочий стол', 'Страницы'], 'metronic') !!}
            </div>
        </div>
    </div>
...
@section('js')
    ...
    @php $pages = json_encode($pages, JSON_HEX_TAG | JSON_HEX_APOS | JSON_HEX_QUOT | JSON_HEX_AMP | JSON_UNESCAPED_UNICODE) @endphp
    <script type="text/javascript">
        var DatatableMenu = function() {
            var e = function() {
                var e = JSON.parse('<?php echo $pages; ?>')
                    ...
                    columns: [{
                        ...
                        template: function(e) {
                            return '<div class="dropdown ' + (e.getDatatable().getPageSize() - e.getIndex() <= 4 ? "dropup" : "") + '">' +
                                ...
                                '<a class="dropdown-item" href="/admin/pages/'+e.id+'"><i class="la la-edit"></i> Редактировать</a>' +
                                '<a class="dropdown-item" href="/admin/pages/delete?id='+e.id+'"><i class="la la-print"></i> Удалить' +
                                '</a></div></div>' +
