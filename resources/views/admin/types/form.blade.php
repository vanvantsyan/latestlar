    ...
    <div class="m-subheader ">
        <div class="d-flex align-items-center">
            <div class="mr-auto">
                ...
                {!! Breadcrumbs::generate(['Рабочий стол', 'Тип', 'Добавить тип'], 'metronic') !!}
            </div>
        </div>
    </div>
    ...
    <div class="m-content">
        <div class="m-portlet m-portlet--mobile">
            <div class="m-portlet__body">
                ...
                @php
                    $link = isset($item) ? url('admin/types/'.$item->id) : url('admin/types') ;
                @endphp
                ...
                <form action="{{ $link }}" method="POST" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="col-md-12">
                        ...
                        <a href="{{url('admin/types')}}" class="btn btn-danger">Отмена</a>
                    </div>
                </form>
            ...
            init: function () {
                ...
                thisDropzone.on("removedfile", function (file) {
                    ...
                    $.ajax({
                        ...
                        cache: false,
                        data: {id: '{{$item->id}}', name: file.name, ess: 'ToursTagsValues'},
                        type: "POST",
                    }).done(function (data) {
